...
import 'package:eshopping/view/register_view.dart';
...
class LoginView extends StatelessWidget {
  ...
  Scaffold buildScaffold(BuildContext context, LoginState state) {
    return Scaffold(
      ...
      body: context.watch<LoginCubit>().isLoading == true ? Center(child: CircularProgressIndicator()) : Form(
  ...
  Padding buildTextFormFieldPassword(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (value)=>value!.length<1?AppLocalizations.of(context)!.enterPasswordError: null,
